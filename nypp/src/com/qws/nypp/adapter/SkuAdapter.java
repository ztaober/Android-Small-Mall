...
public class SkuAdapter extends BaseAdapter {
	private List<SukTypeBean> list;//数据源
	...
	public SkuAdapter(List<SukTypeBean> list, Context context) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final SukTypeBean bean = list.get(position);
