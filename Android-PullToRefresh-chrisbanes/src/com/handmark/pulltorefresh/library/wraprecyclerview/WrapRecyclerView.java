package com.handmark.pulltorefresh.library.wraprecyclerview;
...
public class WrapRecyclerView extends RecyclerView {
    ...
    private ArrayList<View> mTmpHeaderView = new ArrayList<View>();
    // 临时尾部View集合,用于存储没有设置Adapter之前添加的尾部
    private ArrayList<View> mTmpFooterView = new ArrayList<View>();
